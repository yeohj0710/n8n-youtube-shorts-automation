...
function stripChannelFooter(code) {
  return String(code)
    ...
    .replace(
      /The one exception is the channel handle @haruyaksa inside the footer line: render those exact letters\. No other English or Latin-alphabet text anywhere\.|No English or Latin-alphabet text at all\./g,
      'CHANNEL_HANDLE_WHITELIST',
    );
}
