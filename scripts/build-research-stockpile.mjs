...
export const PACKS = [
  {
    channel: 'haru',
    slug: '01-supplement-combinations',
    pillar: 'supplement_ingredients',
    lane: 'food_nutrition_table',
    queries: [
      'NIH office of dietary supplements iron coffee tea calcium reduce absorption',
      'vitamin D fat soluble absorbed better with meal containing fat',
      'magnesium supplement antibiotic bisphosphonate separate hours',
    ],
    sources: [
      { id: 'S1', ...ODS('Iron', 'Iron', '2023-08-17') },
      { id: 'S2', ...ODS('Calcium', 'Calcium', '2024-07-16') },
      { id: 'S3', ...ODS('Vitamin D', 'VitaminD', '2024-07-26') },
      { id: 'S4', ...ODS('Magnesium', 'Magnesium', '2022-06-02') },
    ],
    facts: [
      ['F1', ['S1'], '식사와 함께 마시는 커피나 차는 철분 흡수를 떨어뜨린다.',
        '미국 국립보건원 자료는 식사 때 차와 커피를 피하면 식물성 식품에 들어 있는 철분의 흡수가 좋아진다고 안내한다.',
        '챙겨 먹는 철분을 같이 마신 커피 한 잔이 깎는다는 점은 잘 알려져 있지 않다.', '식후 커피는 중장년에게 가장 굳어 있는 습관이다.',
        '철분을 챙기는 날은 식사와 커피 사이를 띄운다.', '식사와 같은 때 마실 때 해당한다.', '고기의 철분보다 채소·곡물의 철분에서 영향이 크다.', 'high'],
      ['F2', ['S1'], '우유처럼 칼슘이 든 음식과 함께 먹으면 철분 흡수가 떨어진다.',
        '국립보건원 자료는 식사 때 칼슘이 들어 있는 우유를 피하면 철분 흡수가 좋아진다고 안내한다.',
        '영양제를 우유로 넘기는 것이 부드럽고 좋다는 통념과 반대다.', '약이나 영양제를 우유와 함께 넘기는 사람이 많다.',
        '철분을 먹을 때는 우유 대신 물로 넘긴다.', '철분을 챙기는 것이 목적일 때 해당한다.', '칼슘을 피하라는 뜻이 아니라 같은 때를 피하라는 뜻이다.', 'high'],
      ['F3', ['S1', 'S2'], '칼슘과 철분은 같은 때 먹지 말고 시간을 나눠 먹도록 권한다.',
        '국립보건원 자료는 칼슘이 철분 흡수를 방해할 수 있어 칼슘과 철분 보충제를 하루 중 서로 다른 때에 먹도록 전문가들이 권한다고 설명한다.',
        '몸에 좋은 것 두 가지를 한 번에 챙기려는 행동이 오히려 손해가 된다.', '아침에 영양제를 한꺼번에 털어 넣는 습관에 해당한다.',
        '칼슘과 철분은 아침저녁으로 나눠 먹는다.', '보충제로 함께 먹을 때 해당한다.', '방해 정도가 확정적으로 정해진 것은 아니다.', 'moderate_high'],
      ['F4', ['S3'], '비타민D는 기름기가 있는 식사와 함께 먹어야 잘 흡수된다.',
        '국립보건원 자료는 비타민D가 지용성이라 지방이 들어 있는 식사나 간식과 함께 먹을 때 가장 잘 흡수된다고 설명한다.',
        '빈속에 먹는 것이 더 좋다고 여겨 아침 공복에 챙기는 습관과 반대다.', '아침 공복에 영양제를 먹는 사람이 많다.',
        '비타민D는 빈속 대신 식사 뒤에 먹는다.', '식사에 어느 정도 지방이 있어야 한다.', '많이 기름진 식사가 필요하다는 뜻은 아니다.', 'high'],
      ['F5', ['S4'], '마그네슘은 일부 항생제나 골다공증 약과 시간을 띄워 먹어야 한다.',
        '국립보건원 자료는 마그네슘이 특정 계열 항생제와 결합해 흡수를 줄일 수 있어 최소 두 시간 간격을 두도록 하고, 먹는 골다공증 약과도 최소 두 시간 간격을 두도록 안내한다.',
        '약을 잘 챙기려고 한꺼번에 먹는 행동이 약효를 깎을 수 있다.', '골다공증 약이나 항생제를 먹는 중장년에게 직접 해당한다.',
        '그 약을 먹는 날은 마그네슘을 다른 때로 옮긴다.', '해당 약을 함께 먹는 경우에만 해당한다.', '모든 항생제가 아니라 특정 계열에 해당한다.', 'high'],
    ],
    angle: '영양제는 무엇을 고르냐보다 무엇과 같이, 언제 먹느냐에서 손해가 갈린다.',
    rejected: ['영양제 제형별 흡수율 비교 - 화학 이름과 수치가 시청자 눈높이를 벗어남', '결핍 증상 나열 - 증상이 비특이적이라 판단을 바꾸지 못함'],
    topicKey: 'supplement_pairing_timing',
    card: {
      hook: '같이 먹으면 서로 방해하는 영양제 조합 5',
      sub: '뭘 고르냐보다 뭐랑 같이 먹느냐에서 갈려요',
      visualProfile: 'market_receipt',
      mood: '아침 식탁 위에 놓인 영양제 통과 물컵, 커피잔과 우유잔이 나란히 놓인 정갈한 장면, 크림색과 세이지 그린 배경에 따뜻한 아침 햇살, 종이 질감',
      bgm: 'warm gentle felt piano, calm and reassuring morning mood',
      script: '영양제는 같이 먹는 것부터 확인해요.',
      desc: '같이 먹으면 손해 보는 조합을 정리했어요.',
      comment: '영양제는 무엇을 고르냐보다 무엇과 같이 먹느냐가 더 크게 갈려요. 커피와 우유, 그리고 약과 겹치는 시간만 옮겨도 손해를 줄일 수 있어요. 구독하시고 성분과 몸의 원리를 쉽게 이해하는 건강 정보를 받아보세요.',
      tags: ['건강정보', '시니어건강', '영양제'],
      items: [
        ['F1', ['S1'], '철분제와 식후 커피', '철분제와 식후 커피', '식사 때 커피나 차를 같이 마시면 음식에 든 철분이 잘 흡수되지 않아요', '식사 때 커피를 같이 마시면 철분이 덜 흡수돼요'],
        ['F2', ['S1'], '영양제를 우유로 넘기기', '영양제를 우유로 넘기기', '부드럽게 넘기려고 우유를 쓰면 우유 속 칼슘이 철분 흡수를 방해해요', '우유 속 칼슘이 철분 흡수를 방해해서 물로 넘겨야 해요'],
        ['F3', ['S1', 'S2'], '칼슘과 철분을 한 번에', '칼슘과 철분을 한 번에', '몸에 좋은 걸 한꺼번에 챙기려다 서로 흡수를 방해해서 아침저녁으로 나눠 먹는 편이 좋아요', '칼슘과 철분은 서로 방해해서 아침저녁으로 나눠 먹어요'],
        ['F4', ['S3'], '비타민D를 빈속에', '비타민D를 빈속에', '비타민D는 기름기 있는 식사와 함께 먹어야 잘 흡수돼서 아침 공복은 손해예요', '비타민D는 기름기 있는 식사 뒤에 먹어야 잘 흡수돼요'],
        ['F5', ['S4'], '약과 마그네슘을 같은 때', '항생제와 마그네슘을 같은 때', '항생제나 골다공증 약을 마그네슘과 같은 때 먹으면 약이 잘 흡수되지 않아 두 시간은 띄워요', '항생제와 마그네슘을 같이 먹으면 약 흡수가 떨어져요'],
      ],
    },
  },
  ...
  {
    channel: 'longevity',
    slug: '02-home-blood-pressure',
    pillar: 'cardiometabolic',
    lane: 'daily_health_lifestyle',
    queries: [
      '가정혈압 측정 방법 대한고혈압학회 팔 높이 심장 다리 꼬지 않기',
      '가정혈압 아침 저녁 2회 측정 평균 5-7일',
      '대한고혈압학회 2026 고혈압 진료지침 가정혈압 검증된 혈압계',
    ],
    sources: [
      { id: 'S1', title: '가정혈압 측정 교육자료', publisher: '대한고혈압학회', url: 'https://www.koreanhypertension.org/sense/family', published_at: '', source_type: 'professional_society' },
      { id: 'S2', title: '대한고혈압학회 "가정혈압, 검증된 혈압계로 측정해야"', publisher: '비건뉴스 (대한고혈압학회 2026 진료지침 인용)', url: 'https://www.vegannews.co.kr/news/article.html?no=384038', published_at: '', source_type: 'news_citing_society' },
      { id: 'S3', title: '고혈압 진료지침', publisher: '대한고혈압학회', url: 'https://www.koreanhypertension.org/reference/guide', published_at: '', source_type: 'clinical_guideline' },
    ],
    facts: [
      ['F1', ['S1'], '가정혈압은 의자에 등을 기대고 앉아 5분 정도 안정한 뒤에 재야 한다.',
        '대한고혈압학회의 가정혈압 측정 안내는 아침에 기상해 소변을 본 뒤 책상이나 식탁 앞 의자에 등을 기대고 앉아 5분 정도 안정한 후에 측정하도록 설명한다.',
        '집에 들어오자마자 혹은 앉자마자 재는 습관이 숫자를 실제보다 높게 만든다.', '집에서 혈압을 재는 중장년에게 그대로 해당한다.',
        '재기 전에 앉아서 잠시 쉬었다가 잰다.', '앉은 자세로 안정한 뒤에 해당한다.', '기계와 팔 굵기에 따른 오차는 별개다.', 'high'],
      ['F2', ['S1'], '혈압계 커프는 심장 높이에 와야 한다.',
        '같은 안내는 팔에 감는 커프가 심장 높이에 오도록 위치시키고, 커프를 감은 팔을 책상에 올려 심장 높이로 맞추라고 설명한다.',
        '팔을 무릎에 두거나 늘어뜨리면 같은 사람도 숫자가 달라진다.', '식탁에서 재는 상황에 바로 적용된다.',
        '팔을 책상에 올려 심장 높이로 맞춘다.', '팔에 감는 혈압계 기준이다.', '손목형 혈압계는 사용법이 다르다.', 'high'],
      ['F3', ['S1'], '다리를 꼬지 않고 발을 바닥에 붙인 자세로 재야 한다.',
        '같은 안내는 등받이에 등을 기대고 다리를 꼬지 않은 채 발을 바닥에 붙이고 측정하도록 설명한다.',
        '편하게 다리를 꼬고 재는 흔한 자세가 결과를 흔든다.', '소파나 식탁에서 재는 상황에 해당한다.',
        '다리를 풀고 두 발을 바닥에 붙인 뒤 잰다.', '앉아서 재는 경우에 해당한다.', '자세 외의 다른 요인도 함께 작용한다.', 'high'],
      ['F4', ['S1'], '측정 중에는 움직이거나 말하지 않아야 한다.',
        '같은 안내는 측정 중에 움직임과 말을 자제해야 한다고 설명한다.',
        '재면서 대화하는 습관이 결과를 바꾼다는 점은 잘 알려져 있지 않다.', '가족과 이야기하며 재는 상황이 흔하다.',
        '기계가 도는 동안에는 말도 움직임도 멈춘다.', '측정이 진행되는 동안에 해당한다.', '한 번의 대화가 얼마나 올리는지는 사람마다 다르다.', 'high'],
      ['F5', ['S1', 'S3'], '가정혈압은 아침과 저녁에 두 번씩, 여러 날의 평균으로 판단한다.',
        '가정혈압 관리지침은 매일 아침과 저녁을 기준으로 각각 두 번 측정하도록 권고하고, 진단과 치료 효과 평가에는 최소 닷새에서 이레 동안의 아침 평균과 저녁 평균이 필요하다고 설명한다. 진단은 반복 측정한 값의 평균으로 하며 한 번의 측정값만으로 하지 않는다.',
        '한 번 높게 나온 값에 놀라거나 한 번 낮게 나온 값에 안심하는 것이 가장 흔한 오해다.', '혈압을 재는 중장년이 매번 겪는 상황이다.',
        '한 번 값에 일희일비하지 말고 며칠치 평균으로 본다.', '가정에서 재는 혈압에 해당한다.', '증상이 있으면 평균과 무관하게 진료를 받아야 한다.', 'high'],
      ['F6', ['S2'], '가정혈압은 국제적으로 검증 절차를 거친 혈압계로 재도록 권고한다.',
        '대한고혈압학회는 2026 고혈압 진료지침에서 가정혈압 측정 시 국제적으로 표준화된 검증 절차를 거친 혈압계를 사용하도록 권고했다.',
        '어떤 기계로 재는지가 권고 사항이라는 점은 잘 알려져 있지 않다.', '오래된 혈압계를 그대로 쓰는 집이 많다.',
        '검증된 제품인지 확인하고 쓴다.', '가정에서 쓰는 혈압계에 해당한다.', '검증 제품이라도 정기적인 점검은 필요하다.', 'moderate_high'],
    ],
    angle: '집에서 재는 혈압은 기계보다 자세와 횟수에서 숫자가 갈린다.',
    rejected: ['혈압 수치 기준 설명 - 임상 수치는 시청자 눈높이에 맞지 않음', '고혈압 합병증 나열 - 겁주기이고 오늘 할 행동이 없음', '혈압약 종류 비교 - 개별 처방 영역이라 다루지 않음'],
    topicKey: 'home_bp_measurement_method',
    card: {
      hook: '혈압 잴 때 결과를 흔드는 실수 5',
      sub: '기계가 아니라 자세에서 숫자가 갈려요',
      visualProfile: 'wellness_dashboard',
      mood: '아침 식탁에 놓인 가정용 혈압계와 팔을 올린 손, 창으로 들어오는 부드러운 아침 빛, 크림색과 차분한 청록 팔레트, 나무 식탁 질감',
      bgm: 'gentle acoustic piano with soft bowed strings, calm and steady morning mood',
      script: '혈압은 재는 자세부터 확인해요.',
      desc: '집에서 혈압 잴 때 결과를 흔드는 실수를 정리했어요.',
      comment: '집에서 재는 혈압은 기계보다 자세와 횟수에서 숫자가 갈려요. 앉아서 잠시 쉬고, 팔을 심장 높이에 두고, 며칠치 평균으로 보는 것만 지켜도 훨씬 정확해져요. 구독하시고 건강한 노년을 지키는 습관을 함께 이어가요.',
      tags: ['건강정보', '시니어건강', '혈압관리'],
      items: [
        ['F1', ['S1'], '앉자마자 바로 재기', '앉자마자 바로 재기', '등을 기대고 앉아 5분 정도 쉰 다음에 재야 제 숫자가 나와요', '등을 기대고 5분쯤 쉰 다음에 재야 제 숫자가 나와요'],
        ['F2', ['S1'], '팔을 심장보다 낮게 두기', '팔을 심장보다 낮게 두기', '커프를 감은 팔을 책상에 올려 심장 높이에 맞춰야 정확해요', '팔을 책상에 올려 심장 높이에 맞춰야 정확해요'],
        ['F3', ['S1'], '다리 꼬고 재기', '다리를 꼬고 재기', '다리를 꼬지 않고 두 발을 바닥에 붙인 자세로 재도록 권해요', '다리를 풀고 두 발을 바닥에 붙인 자세로 재야 해요'],
        ['F4', ['S1'], '재면서 이야기하기', '재면서 이야기하기', '기계가 도는 동안에는 움직임과 말을 멈춰야 해요', '혈압계가 도는 동안에는 말도 움직임도 멈춰야 해요'],
        ['F5', ['S1', 'S3'], '한 번 재고 판단하기', '한 번 재고 판단하기', '아침저녁으로 두 번씩 며칠을 재서 그 평균으로 봐야 해요', '아침저녁으로 며칠 재서 그 평균으로 봐야 해요'],
      ],
    },
  },
...

  {
    ...
    card: {
      hook: '양말 신을 때 몸이 알려주는 것 5',
      sub: '매일 하는 그 짧은 동작에 다 나와 있어요',
...

  {
    ...
    card: {
      hook: '텔레비전 소리를 자꾸 키우게 되는 이유 5',
      sub: '귀만 탓하기 전에 확인할 것들이에요',
...

  {
    ...
    card: {
      hook: '안경 닦는 습관이 눈을 피곤하게 만드는 이유 5',
      sub: '눈이 침침한 게 아니라 렌즈였을 수 있어요',
      ...
      items: [
        ...
        ['F2', ['S1', 'S2'], '먼지째 마른 천으로 문지르기', '먼지째 마른 천으로 문지르기', '문지르기 전에 물로 먼저 헹궈서 먼지를 없애는 편이 안전해요', '마른 천으로 문지르기 전에 물로 먼저 헹궈 주세요'],
  ...
  {
    channel: 'longevity',
    slug: '03-stairs-knee-descent',
    pillar: 'joints_balance_falls',
    lane: 'movement_mobility_longevity',
    queries: [
      '계단 내려올 때 무릎 통증 오를 때보다 부담 정형외과',
      '질병관리청 낙상 예방 계단 손잡이 천천히',
      'stair descent initial foot contact strategy knee joint moments',
    ],
    sources: [
      { id: 'S1', title: '계단을 오르내릴 때 느끼는 무릎 통증, 신체가 보내는 경고 신호', publisher: '성누가병원 정형외과', url: 'https://slmc.co.kr/board/bbs/board.php?bo_table=column&wr_id=209', published_at: '2026-05-15', source_type: 'hospital_health_info' },
      { id: 'S2', title: '낙상', publisher: '질병관리청 국가건강정보포털', url: 'https://health.kdca.go.kr/healthinfo/biz/health/gnrlzHealthInfo/gnrlzHealthInfo/gnrlzHealthInfoView.do?cntnts_sn=1743', published_at: '', source_type: 'government_health_agency' },
      { id: 'S3', title: 'Influence of the initial foot contact strategy on knee joint moments during stair and ramp descent', publisher: 'Scientific Reports (PMC, NIH)', url: 'https://pmc.ncbi.nlm.nih.gov/articles/PMC7435172/', published_at: '', source_type: 'clinical_guideline' },
    ],
    facts: [
      ['F1', ['S1'], '계단은 올라갈 때보다 내려올 때 무릎이 더 많이 버틴다.',
        '정형외과 자료는 계단을 내려올 때 속도가 붙은 몸을 무릎 주변 근육과 연골이 그대로 받아내야 해서 오를 때보다 부담이 크다고 설명한다.',
        '힘든 쪽은 올라가는 길인데 무릎이 상하는 쪽은 내려오는 길이다.', '계단은 매일 오르내린다.',
        '내려올 때를 더 조심한다.', '내려오는 동작에 해당한다.', '재는 방법에 따라 결과가 갈리기도 한다.', 'moderate_high'],
      ['F2', ['S2', 'S1'], '난간을 잡으면 무릎이 혼자 받던 몸을 나눠 받는다.',
        '질병관리청 낙상 자료는 계단에서 손잡이를 잡고 천천히 이동하도록 권하고, 정형외과 자료도 난간을 가볍게 짚으면 무릎에 실리는 힘을 나누는 데 도움이 된다고 설명한다.',
        '난간은 넘어질까 봐 잡는 줄 알았는데 무릎을 위한 것이기도 하다.', '계단마다 난간이 있다.',
        '내려올 때 난간에 손을 얹는다.', '난간이 있을 때에 해당한다.', '잡아도 체중 대부분은 여전히 다리가 받는다.', 'high'],
      ['F3', ['S2'], '두 칸씩 서둘러 내려가면 한 발이 받는 충격이 커진다.',
        '질병관리청 낙상 자료는 계단에서 천천히 이동하도록 권하며, 한 번에 내려딛는 높이가 커질수록 다리가 흡수해야 하는 충격이 커진다.',
        '바쁠 때 한 칸씩 아끼는 그 순간이 가장 부담이 크다.', '급할 때 두 칸씩 내려가는 사람이 많다.',
        '급해도 한 칸씩 내려온다.', '내려딛는 높이가 클 때에 해당한다.', '두 칸씩을 직접 다룬 국내 지침은 없다.', 'moderate_high'],
      ['F4', ['S3'], '뒤꿈치부터 쿵 찍듯 내려디디면 무릎에 실리는 힘이 더 커진다.',
        '해외 학술지 연구는 계단을 내려올 때 앞꿈치가 먼저 닿는 방식이 뒤꿈치부터 닿는 방식보다 무릎에 걸리는 힘이 낮았다고 보고했다.',
        '소리가 크게 나는 발걸음이 무릎에도 크게 실린다는 점은 잘 알려져 있지 않다.', '계단 소리로 본인 걸음을 알 수 있다.',
        '쿵 소리가 나면 사뿐히 딛는 쪽으로 바꾼다.', '발이 계단에 처음 닿는 방식에 해당한다.', '앞꿈치로 딛으면 종아리가 더 일한다.', 'moderate_high'],
    ],
    angle: '계단에서 무릎이 상하는 것은 오르는 힘이 아니라 내려오는 방식에서 갈린다.',
    rejected: ['무릎 하중 배수 수치 - 임상 수치라 눈높이를 벗어남', '관절염 단계 설명 - 진단 영역이라 채널 범위를 벗어남', '짐을 한쪽으로 들기 - 오히려 반대쪽 부담이 커진다는 연구가 있어 근거가 엇갈림'],
    topicKey: 'stairs_descent_knee_load',
    card: {
      hook: '계단 내려올 때 무릎이 먼저 아픈 이유 4',
      sub: '오를 때보다 내려올 때가 문제예요',
      visualProfile: 'wellness_dashboard',
      mood: '아파트 계단참에 놓인 난간과 한 발을 내딛는 운동화, 창으로 들어오는 부드러운 낮 빛, 따뜻한 회색과 세이지 그린 팔레트, 콘크리트 질감',
      bgm: 'calm steady piano with warm strings, unhurried and reassuring mood',
      script: '계단은 내려올 때가 문제예요.',
      desc: '계단 내려올 때 무릎이 먼저 아픈 이유를 정리했어요.',
      comment: '계단에서 무릎이 상하는 건 올라갈 때가 아니라 내려올 때예요. 난간에 손을 얹고 한 칸씩 사뿐히 내려오는 것만 지켜도 달라져요. 구독하시고 건강한 노년을 지키는 습관을 함께 이어가요.',
      tags: ['건강정보', '시니어건강', '무릎관절'],
      items: [
        ['F1', ['S1'], '내려올 때 무릎이 더 버티기', '내려올 때 무릎이 더 버티기', '속도가 붙은 몸을 무릎이 받아내야 해서 오를 때보다 부담이 커요', '무릎에 실리는 힘은 오를 때보다 내려올 때가 더 커요'],
        ['F2', ['S2', 'S1'], '난간을 잡지 않기', '난간을 잡지 않기', '난간에 손을 얹으면 무릎이 혼자 받던 몸무게를 나눠 받게 돼요', '난간에 손을 얹으면 무릎이 받던 몸무게를 나눠 받아요'],
        ['F3', ['S2'], '두 칸씩 서둘러 내려가기', '두 칸씩 서둘러 내려가기', '한 번에 내려딛는 높이가 커질수록 한 발이 받는 충격도 커져요', '두 칸씩 내려디디면 한 발이 받는 충격이 그만큼 커져요'],
        ['F4', ['S3'], '뒤꿈치부터 쿵 찍기', '뒤꿈치부터 쿵 찍기', '계단 소리가 크게 날수록 무릎에 실리는 힘도 크다는 뜻이에요', '뒤꿈치로 쿵 찍어 내려디디면 무릎에 힘이 더 실려요'],
      ],
    },
  },

  {
    ...
    card: {
      ...
      items: [
        ['F1', ['S1'], '의자나 침대에 올라서기', '의자나 침대에 올라서기', '올라서서 꺼내는 대신 집게를 쓰거나 사람을 부르라고 권해요', '의자나 침대는 흔들려서 올라서면 넘어지기 쉬워요'],
        ['F2', ['S3'], '고개를 젖히고 오래 올려다보기', '고개 젖히고 오래 보기', '목을 뒤로 젖히는 각도가 커질수록 몸의 흔들림도 커져요', '고개를 뒤로 젖힌 채로 오래 보면 몸이 휘청거려요'],
        ['F3', ['S1'], '무거운 것을 높은 칸에 두기', '무거운 것을 높은 칸에 두기', '자주 쓰는 물건은 손이 쉽게 닿는 곳에 두라고 안내해요', '무겁고 자주 쓰는 건 손 닿는 아래 칸에 둬야 해요'],
        ['F4', ['S4'], '두 손으로 받아 들기', '두 손으로 받아 들기', '넘어질 때 손이 비어 있어야 붙잡아 몸을 지킬 수 있어요', '두 손이 막히면 넘어질 때 붙잡을 손이 없어요'],
        ['F5', ['S2'], '어두운 데서 더듬어 꺼내기', '어두운 데서 더듬어 꺼내기', '낙상 예방 수칙은 어두운 곳과 모서리를 밝게 하라고 안내해요', '불을 켜고 눈으로 확인한 뒤에 손을 넣어야 해요'],
      ],
    },
  },

  {
    ...
    card: {
      hook: '설거지하는 자세가 허리에 남기는 것 5',
      sub: '시간이 아니라 서 있는 방법이 문제예요',
      ...
      items: [
        ...
        ['F2', ['S1', 'S2'], '두 발을 바닥에만 두기', '두 발을 바닥에만 두기', '한쪽 발을 낮은 받침에 번갈아 올리면 척추를 곧게 유지하는 데 도움이 돼요', '낮은 받침에 한 발씩 번갈아 올려 보세요. 허리가 한결 편해요'],
        ['F3', ['S1'], '솥을 허리만 숙여 들기', '솥을 허리만 숙여 들기', '무거운 건 무릎을 굽히고 몸에 붙여서 무릎 힘으로 들어 올려야 해요', '무거운 솥은 무릎을 굽혀 몸에 붙여서 들어야 해요'],
...

  {
    ...
    card: {
      hook: '병원 갈 때 챙겨가면 진료가 빨라지는 것 5',
      sub: '준비가 없으면 3분이 그냥 지나가요',
      visualProfile: 'clinic_checklist',
