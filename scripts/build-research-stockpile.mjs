...
export const PACKS = [
  {
    ...
    card: {
      ...
      sub: '매일 아침 몇 초 사이에 다 드러나는 신호들이에요',
      ...
      items: [
        ...
        ['F4', ['S4'], '발 감각이 둔해지기', '발 감각이 둔해지기', '양말이 닿는 느낌이 예전 같지 않은 날이 이어지면 발 감각이 둔해진 거예요', '양말 닿는 느낌이 계속 둔하면 발을 눈으로 살펴보세요'],
...

  {
    ...
    card: {
      ...
      items: [
        ...
        ['F2', ['S2'], '높은 소리부터 안 들리기', '높은 소리부터 안 들리기', '소리는 들리는데 말이 뭉개져 들리면 높은 소리부터 안 들리는 거예요', '소리는 들리는데 말이 뭉개지면 높은 소리부터 줄어든 거예요'],
        ['F3', ['S2'], '주변 소음이 말소리를 덮기', '주변이 시끄럽기', '환풍기나 물소리가 켜져 있으면 말소리가 묻혀서 더 안 들려요', '환풍기랑 물소리 때문에 말이 안 들리는 거예요'],
        ['F4', ['S3'], '한쪽 귀만 나빠지기', '한쪽 귀만 나빠지기', '한쪽만 나빠지면 본인은 잘 모르고 리모컨만 자꾸 누르게 돼요', '한쪽만 나빠지면 본인은 모른 채 볼륨만 자꾸 올리게 돼요'],
