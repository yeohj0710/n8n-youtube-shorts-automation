...
export const PACKS = [
  {
    ...
    card: {
      ...
      tags: ['건강정보', '시니어건강', '귀건강'],
      items: [
        ['F1', ['S1'], '귀지가 귓길을 막고 있는지', '귀지가 귓길을 막고 있는지', '면봉으로 파내면 오히려 안쪽으로 밀려 들어가 더 막히게 돼요', '면봉으로 파낼수록 귀지가 안쪽으로 더 들어가 버려요'],
        ['F2', ['S2'], '높은 소리만 안 들리는지', '높은 소리만 안 들리는지', '소리는 들리는데 말이 뭉개져 들리면 높은 소리부터 안 들리는 거예요', '소리는 들리는데 말이 뭉개지면 높은 소리부터 줄어든 거예요'],
        ['F3', ['S2'], '주변 소음 때문은 아닌지', '주변 소음 때문은 아닌지', '환풍기나 물소리가 켜져 있으면 말소리가 묻혀서 더 안 들려요', '환풍기랑 물소리 때문에 말이 안 들리는 거예요'],
        ['F4', ['S3'], '한쪽 귀만 나빠진 건 아닌지', '한쪽 귀만 나빠진 건 아닌지', '한쪽만 나빠지면 본인은 잘 모르고 리모컨만 자꾸 누르게 돼요', '한쪽만 나빠지면 본인은 모른 채 볼륨만 자꾸 올리게 돼요'],
        ['F5', ['S4'], '크게 오래 듣는 습관 때문인지', '크게 오래 듣는 습관 때문인지', '크게 오래 듣는 것 자체가 귀를 더 나쁘게 만들어 다시 키우게 돼요', '크게 오래 들을수록 귀가 더 나빠져서 또 키우게 돼요'],
      ],
    },
  },
...

  {
    ...
    card: {
      ...
      sub: '발밑에 받침 하나만 놓아도 허리가 한결 편해져요',
...

  {
    ...
    card: {
      ...
      items: [
        ...
        ['국물용 멸치와 다시마', '국물용 멸치와 다시마', '상온에 두면 눅눅해지고 비린내가 나는데 얼려 두면 맛이 그대로예요', '상온에 둔 멸치는 눅눅해지고 비린내가 나기 쉬워요'],
      ],
    },
  },
...

  {
    ...
    card: {
      ...
      tags: ['건강정보', '시니어건강', '노후생활'],
      items: [
        ['신발이 첫 번째', '신발', '하루 종일 몸무게를 받는 물건이라 제일 먼저 좋은 걸로 바꿔요', '하루 종일 몸무게를 받는 유일한 물건이에요'],
  ...
  // A by-interval card is not a ranking, so labelMode turns off the N위 numbering.
  {
    ...
    card: {
      ...
      items: [
        ...
        ['수세미는 한 달', '수세미 - 한 달', '기름때가 밴 수세미는 아무리 헹궈도 냄새가 남아요', '기름때가 배면 아무리 헹궈도 냄새가 남아요'],
